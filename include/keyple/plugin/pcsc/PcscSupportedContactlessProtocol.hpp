...
/**
 * Non-exhaustive list of protocols supported by common contactless PC/SC
 * readers.
 *
 * <p>Tested with
 *
 ...
 * </ul>
 *
 * <p><b>Note:</b> the definition of ATR for contactless ISO cards and memory
 * cards (a.k.a. storage cards) is defined in the PC/SC standard Part 3, core
 * and supplementary documents. <br>
...
public:
     ...
     * @since 2.0.0
     */
    static const PcscSupportedContactlessProtocol ISO_14443_4;
     ...
     * @since 2.0.0
     */
    static const PcscSupportedContactlessProtocol INNOVATRON_B_PRIME_CARD;
     ...
     * @since 2.0.0
     */
    static const PcscSupportedContactlessProtocol MIFARE_ULTRA_LIGHT;
     ...
     * @since 2.0.0
     */
    static const PcscSupportedContactlessProtocol MIFARE_CLASSIC;
     ...
     * @since 2.0.0
     */
    static const PcscSupportedContactlessProtocol MIFARE_DESFIRE;
     ...
     * @since 2.0.0
     */
    static const PcscSupportedContactlessProtocol MEMORY_ST25;
